...
insert ALL
    ...
    into produto values  (25, 'KG', 'Queijo', 0.97)
    into produto values  (31, 'BAR', 'Chocolate', 0.87)
    into produto values  (78, 'L', 'Vinho', 2.00)
    into produto values  (22, 'M', 'Linho', 0.11)
    into produto values  (30, 'SAC', 'Açúcar', 0.30)
    into produto values  (53, 'M', 'Linha', 1.80)
    into produto values  (13, 'G', 'Ouro', 6.18)
    into produto values  (45, 'M', 'Madeira', 0.25)
    into produto values  (87, 'M', 'Cano', 1.97)
    into produto values  (77, 'M', 'Papel', 1.05)
SELECT * FROM dual;